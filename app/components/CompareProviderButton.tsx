...
import { onSelectProvider } from "../lib/events";
...
export default function CompareProviderButton({ providerId }: CompareProviderButtonProps) {
  ...
  return (
    ...
    >
      {isSelected ? "홈 비교에서 제거" : "이 공급자 비교에 추가"}
    </button>
  );
}
